...
The material is adapted from the [Data Carpentry: Shell Genomics](https://datacarpentry.org/shell-genomics/) lesson. 
...
- Query [NCBI](https://www.ncbi.nlm.nih.gov/) databases and download a genome sequence from the command line
